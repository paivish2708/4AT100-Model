...
//!	Generated Date	: Sat, 30, May 2020  
	File Path	: DefaultComponent\EmergencyOverrideBlock_Simulation\Obstacle.cpp
*********************************************************************/
...
EmergencyOverrideBlock* Obstacle::getItsEmergencyOverrideBlock() const {
    return itsEmergencyOverrideBlock;
}

void Obstacle::setItsEmergencyOverrideBlock(EmergencyOverrideBlock* p_EmergencyOverrideBlock) {
    if(p_EmergencyOverrideBlock != NULL)
        {
            p_EmergencyOverrideBlock->_setItsObstacle(this);
        }
    ...
    if(itsEmergencyOverrideBlock != NULL)
        {
            ...
            Obstacle* p_Obstacle = itsEmergencyOverrideBlock->getItsObstacle();
            if(p_Obstacle != NULL)
                {
                    itsEmergencyOverrideBlock->__setItsObstacle(NULL);
                }
            itsEmergencyOverrideBlock = NULL;
        }
}
...
void Obstacle::__setItsEmergencyOverrideBlock(EmergencyOverrideBlock* p_EmergencyOverrideBlock) {
...
void Obstacle::_setItsEmergencyOverrideBlock(EmergencyOverrideBlock* p_EmergencyOverrideBlock) {
    if(itsEmergencyOverrideBlock != NULL)
        {
            itsEmergencyOverrideBlock->__setItsObstacle(NULL);
        }
...
void Obstacle::_clearItsEmergencyOverrideBlock() {
    NOTIFY_RELATION_CLEARED("itsEmergencyOverrideBlock");
    itsEmergencyOverrideBlock = NULL;
}
