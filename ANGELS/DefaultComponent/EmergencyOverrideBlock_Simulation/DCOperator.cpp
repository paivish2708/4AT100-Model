...
//!	Generated Date	: Sat, 30, May 2020  
	File Path	: DefaultComponent\EmergencyOverrideBlock_Simulation\DCOperator.cpp
*********************************************************************/
...
EmergencyOverrideBlock* DCOperator::getItsEmergencyOverrideBlock() const {
    return itsEmergencyOverrideBlock;
}

void DCOperator::setItsEmergencyOverrideBlock(EmergencyOverrideBlock* p_EmergencyOverrideBlock) {
    if(p_EmergencyOverrideBlock != NULL)
        {
            p_EmergencyOverrideBlock->_setItsDCOperator(this);
        }
    ...
    if(itsEmergencyOverrideBlock != NULL)
        {
            ...
            DCOperator* p_DCOperator = itsEmergencyOverrideBlock->getItsDCOperator();
            if(p_DCOperator != NULL)
                {
                    itsEmergencyOverrideBlock->__setItsDCOperator(NULL);
                }
            itsEmergencyOverrideBlock = NULL;
        }
...
void DCOperator::__setItsEmergencyOverrideBlock(EmergencyOverrideBlock* p_EmergencyOverrideBlock) {
...
void DCOperator::_setItsEmergencyOverrideBlock(EmergencyOverrideBlock* p_EmergencyOverrideBlock) {
    if(itsEmergencyOverrideBlock != NULL)
        {
            itsEmergencyOverrideBlock->__setItsDCOperator(NULL);
        }
...
void DCOperator::_clearItsEmergencyOverrideBlock() {
    NOTIFY_RELATION_CLEARED("itsEmergencyOverrideBlock");
    itsEmergencyOverrideBlock = NULL;
}
