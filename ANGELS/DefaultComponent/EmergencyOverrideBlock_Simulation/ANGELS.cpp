...
//!	Generated Date	: Sat, 30, May 2020  
	File Path	: DefaultComponent\EmergencyOverrideBlock_Simulation\ANGELS.cpp
*********************************************************************/
...
ANGELS::ANGELS(IOxfActive* theActiveContext) : ChargeState(15), LoadingTime(0), ParkingTime(0), dt(10) {
    ...
    setActiveContext(theActiveContext, false);
    {
        ...
        {
            itsEmergencyOverrideBlock.setShouldDelete(false);
        }
    }
...
EmergencyOverrideBlock* ANGELS::getItsEmergencyOverrideBlock() const {
    return (EmergencyOverrideBlock*) &itsEmergencyOverrideBlock;
}
...
bool ANGELS::startBehavior() {
    ...
    done &= itsEmergencyOverrideBlock.startBehavior();
...
void ANGELS::setActiveContext(IOxfActive* theActiveContext, bool activeInstance) {
    OMReactive::setActiveContext(theActiveContext, activeInstance);
    {
        ...
        itsEmergencyOverrideBlock.setActiveContext(theActiveContext, false);
    }
}
...
void ANGELS::destroy() {
    ...
    itsEmergencyOverrideBlock.destroy();
...
void OMAnimatedANGELS::serializeRelations(AOMSRelations* aomsRelations) const {
    ...
    aomsRelations->addRelation("itsEmergencyOverrideBlock", true, true);
